...
<p>
  <h2 class="style1">Reference:</h2>
    <p style="margin-left:1em;"> Mike Riddle, Sasan Ardalan, John Suh,<strong> Derivation of Voltage and Current Transfer Functions for Multiconductor Transmission Lines</strong>, Center for Communications and Signal Processing (CCSP), NC State University, 1988. 
